...
namespace SerialAssistant
{
    ...
    {
        public string CLASSID = "O-0005";    //不能重复，L:LIS H:HIS P:Pacs 其余归类到其它
        public string CLASSNAME = "串口调试工具";    //菜单上显示的中文名称
        ...
        private void serialPort1_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                Invoke((EventHandler)(delegate
                {
                    ...
                    toolStripStatusLabel2.Text = "接收：" + receive_count.ToString() + " Bytes";
                }
                  )
                );
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (serialPort1.IsOpen)
                {
                    ...
                    toolStripStatusLabel3.Text = "发送：" + send_count.ToString() + " Bytes";   //刷新界面
        ...
        private void checkBox_Open_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (serialPort1.IsOpen)
                {
                    ...
                    checkBox_Open.Image = global::SerialAssistant.Properties.Resources.bullet_green;
                    checkBox_Open.Text = "  打开串口";
                    comboBox1.Enabled = true;
                    comboBox2.Enabled = true;
                    comboBox3.Enabled = true;
                    comboBox4.Enabled = true;
                    comboBox5.Enabled = true;
                    button_UpdateCOM.Enabled = true;
                    label6.Text = "串口已关闭!";
                    label6.ForeColor = Color.Red;
                    label6.Image = global::SerialAssistant.Properties.Resources.disconnect;
                ...
                else
                {
                    ...
                    button_UpdateCOM.Enabled = false;
                    ...
                    checkBox_Open.Image = global::SerialAssistant.Properties.Resources.bullet_red;
                    checkBox_Open.Text = "  关闭串口";
                    label6.Text = "串口已打开!";
                    label6.ForeColor = Color.Green;
                    label6.Image = global::SerialAssistant.Properties.Resources.connect;
                    //使能发送按钮
        ...
        private void ToolStripMenuItem_Clear_Click(object sender, EventArgs e)
        {
            ...
            send_count = 0;             //发送计数
            toolStripStatusLabel2.Text = "接收：" + receive_count.ToString() + " Bytes";
            toolStripStatusLabel3.Text = "发送：" + receive_count.ToString() + " Bytes";
        }
        ...
        private void ToolStripMenuItem_ClearTx_Click(object sender, EventArgs e)
        {
            //清空发送缓冲区
            textBox2.Text = "";
        }
        ...
        private void button_UpdateCOM_Click(object sender, EventArgs e)
        {
            Update_Serial_List();
        }
    }
